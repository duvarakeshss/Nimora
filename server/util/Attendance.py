...
def getAffordableLeaves(data,custom_percentage):
    ...
    for i in range(len(data)):
        ...
        attendance_percentage = int((classes_present/classes_total)*100)
